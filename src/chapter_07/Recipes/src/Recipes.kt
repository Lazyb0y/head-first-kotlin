...
fun main(args: Array<String>){
    val r1 = Recipe("Thai Currry","Chicken")
    ...
    println("Using a secondary class constructor")
    val m1 = Mushroom(6, false)
    println("mi size is ${m1.size} and isMagic is ${m1.isMagic}")

    val m2 = Mushroom(true)
    println("m2 size is ${m2.size} and isMagic is ${m2.isMagic}\n")

    println("Overloading functions")
